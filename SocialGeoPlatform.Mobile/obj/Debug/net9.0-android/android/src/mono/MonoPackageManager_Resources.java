...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "SocialGeoPlatform.Mobile.dll" comes first in this list. */
		"SocialGeoPlatform.Mobile.dll",
		...
		"SocialGeoPlatform.Core.dll",
		"SocialGeoPlatform.Infrastructure.dll",
